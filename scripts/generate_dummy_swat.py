"""Generate dummy SWaT dataset for development without iTrust access.

Creates train.npy, test.npy, and labels.npy with 51 sensor dimensions.
...
def generate_dummy_swat(output_dir: str = "data/raw/SWaT", seed: int = 42) -> None:
    """Generate dummy SWaT data with injected anomalies.
    ...
    print(f"SWaT dummy data saved to {output_dir}")
